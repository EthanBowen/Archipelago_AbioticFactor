...
def set_all_entrance_rules(world: AbioticFactorWorld) -> None:
...
def set_all_location_rules(world: AbioticFactorWorld) -> None:
...
def set_completion_condition(world: AbioticFactorWorld) -> None:
