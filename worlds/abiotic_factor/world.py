...
from . import options as abiotic_factor_options  # rename due to a name conflict with World.options
...
class AbioticFactorWorld(World):
    """
    Abiotic Factor is a survival crafting game developed by Deep Fields.
    """
    ...
    web = web_world.AbioticFactorWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "abiotic_factor_options" at the top of this file to avoid a name conflict)
    options_dataclass = abiotic_factor_options.AbioticFactorOptions
    options: abiotic_factor_options.AbioticFactorOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.AbioticFactorItem:
