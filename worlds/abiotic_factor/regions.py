...
def create_and_connect_regions(world: AbioticFactorWorld) -> None:
    create_all_regions(world)
    connect_regions(world)


def create_all_regions(world: AbioticFactorWorld) -> None:
...
def connect_regions(world: AbioticFactorWorld) -> None:
